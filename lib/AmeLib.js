...
var AmeLib = /*#__PURE__*/function () {
  function AmeLib(provider, ameAddress) {
    _classCallCheck(this, AmeLib);
    this.web3 = new _web["default"](provider);
    this.AmeWorld = new this.web3.eth.Contract(_AmeWorld["default"], ameAddress);
  }
  return _createClass(AmeLib, [{
    key: "queryComponent",
    value: function () {
    ...
    value: function () {
      var _sendPostRequestWeb3js = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(_componentAddress, _methodName, _requestParams, _from) {
        var componentContract, txResult;
      ...
      function sendPostRequestWeb3js(_x6, _x7, _x8, _x9) {
    ...
    value: function () {
      var _sendPutRequestWeb3js = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(_componentAddress, _methodName, _requestParams, _from) {
        var componentContract, txResult;
      ...
      function sendPutRequestWeb3js(_x10, _x11, _x12, _x13) {
    ...
    value: function () {
      ...
      function hasComponent(_x15, _x16) {
    ...
    value: function () {
      ...
      function registerAmeWorld(_x17) {
    ...
    value: function () {
      ...
      function addComponents(_x18, _x19) {
    ...
    value: function () {
      ...
      function removeComponents(_x20, _x21) {
...
var _default = exports["default"] = AmeLib;